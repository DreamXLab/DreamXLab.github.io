...
<div class="page-wrap">
  ...
  <section id="img1" class="a-reveal">
    <div class="media-block">
      <img class="media" src="{{ '/assets/img/Aftermath/slide1.gif' | relative_url }}" alt="Slide 1">
    </div>
  </section>

  <section id="img2" class="a-reveal">
    <div class="media-block">
      <img class="media" src="{{ '/assets/img/Aftermath/slide2.gif' | relative_url }}" alt="Slide 2">
    </div>
  </section>

  <section id="img2" class="a-reveal">
    <div class="media-block">
      <img class="media" src="{{ '/assets/img/Aftermath/slide3.gif' | relative_url }}" alt="Slide 3">
    </div>
  </section>

  <section id="img2" class="a-reveal">
    <div class="media-block">
      <img class="media" src="{{ '/assets/img/Aftermath/slide4.gif' | relative_url }}" alt="Slide 4">
    </div>
  </section>
  ...
  <section class="refs a-reveal" id="publications">
    ...
    <ul class="refs-list">
      <li>Hu, D., Li, S., Du, J., & Cai, J. (2023). Automating building damage reconnaissance to optimize drone mission planning for disaster response. Journal of Computing in Civil Engineering, 37(3), 04023006.</li>
